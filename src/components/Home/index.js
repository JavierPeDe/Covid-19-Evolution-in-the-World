...
export const Home = () => {
    ...
    return (
        <div>
            ...
            {loading ? <img src={imgLoading} alt="loading..." /> : <DataResponse confirmed={response.confirmed} deaths={response.deaths} recovered={response.recovered} date={response.date} source={response.source} />}
